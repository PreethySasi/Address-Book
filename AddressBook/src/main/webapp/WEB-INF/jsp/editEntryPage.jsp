...
<body>
	...
	<div class="container">
		<form:form method="POST" commandName="addressBookEntry" action="updateEntry.html">
		<form:hidden path="id" value="${entry.id}"/>
			<div class="container">
				...
				<table class="horizontal-buttons">
					<tr>
						<td><button type="submit" class="btn btn-lg btn-primary preview-link">Update Entry</button></td>
