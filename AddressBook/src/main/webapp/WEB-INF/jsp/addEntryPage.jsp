...
<body>
	...
	<div class="container">
		<form:form method="POST" commandName="addressBookEntry" action="addEntry.html">
			<div class="container">
				<h1>Add Entry</h1>
				<table>
					<tr>
				...
				<table class="horizontal-buttons">
					<tr>
						<td><button type="submit" class="btn btn-lg btn-primary preview-link">Add Entry</button></td>
